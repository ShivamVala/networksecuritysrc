from networksecuritysrc.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from networksecuritysrc.entity.config_entity import DataValidationConfig
...
from networksecuritysrc.constant.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import os, sys
from networksecuritysrc.utils.main_utils.utils import read_yaml_file, write_yaml_file
import numpy as np
...
class DataValidation:
    ...
    def validate_numerical_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            missing_columns = [col for col in required_numerical_columns if col not in dataframe_columns]
